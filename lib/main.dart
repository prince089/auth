...
class _AppState extends State<App> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Phoenix Feather authenticator'),
          actions: [
            IconButton(
  ...
  Future check ()async{
    try {
       var url = Uri.parse("https://mpbca.000webhostapp.com/applicationUser/auth.php");

        var responce = await http.post(url, body: {
      "doc":scanResult!.rawContent.toString()
    });
     ...
     if(data > 0){
       ...
       Fluttertoast.showToast(
        msg: "Please Check Your Ticket Again",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.CENTER,
        timeInSecForIosWeb: 1,
      ...
      Fluttertoast.showToast(
        msg: "Something went wrong please contect technical support",
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.CENTER,
        timeInSecForIosWeb: 1,
        backgroundColor: Color.fromARGB(255, 21, 25, 223),
        textColor: Colors.white,
        fontSize: 16.0,
      );
    }
